...
class Attacker(object):
    ...
    def attack(self, person, y,Set_residual,Set_candidate,Set_c,N,iteration):
...
def main(emb_weights, training_file, validation_file,
    ...
    for i in range(0, 200):
        ...
        for n in range(RN):
            ...
            K_set = random.sample(allCode, TopK)
            ...
            pred_set_list = attacker.attack(person, y, K_set, Set_candidate, Set_c, N, iteration)
            INDEX = []
