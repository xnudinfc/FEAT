...
class Attacker(object):
    ...
    def attack(self, person, y,Set_candidate,Set_delet,Set_c):
        ...
        # print('topk_set_feature',topk_set_feature)
...
def main(emb_weights, training_file, validation_file,
    ...
    for i in range(0, 200):
        ...
        time_Dur = 0
        while robust_flag == 1 and len(Set_target[-1]) <= Budget and time_Dur <= SECONDS:
            iteration +=1
            ...
            if ScoreMax >= TAU:
                ...
                # print('Set_candidate',Set_candidate,file=log_f, flush=True)
                # print('set_att',set_att,file=log_f, flush=True)
                # print('F_value',F_value,file=log_f, flush=True)
                # print('F_value',F_value,file=log_f, flush=True)
                break
        ...
        if (i + 1 - NoAttack_num) != 0 and success_num != 0:
            ...
            print("--- Mean TargetCode: " + str(Total_targCode / success_num) + " ---", file=log_f,
                  flush=True)
            print("--- Mean TotalQuery: " + str(Total_query / success_num) + " ---", file=log_f,
                  flush=True)
